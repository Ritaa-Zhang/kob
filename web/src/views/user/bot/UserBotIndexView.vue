...
export default {
    ...
    setup() {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app3779.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app3779.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
        ...
        const update_bot = (bot) => {
            ...
            $.ajax({
                url: "https://app3779.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
